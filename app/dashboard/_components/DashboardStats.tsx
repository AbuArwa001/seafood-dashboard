    ...
    <div className="flex flex-wrap gap-8">
      {stats.map((stat, idx) => (
        <motion.div key={stat.title} variants={itemVariants} className="flex-1 min-w-full sm:min-w-[280px] lg:min-w-[22%]">
          <Card className="border-none shadow-[0_15px_40px_-15px_rgba(0,0,0,0.06)] bg-white rounded-lg   overflow-hidden group hover:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-1.5 transition-all duration-500">
            <CardContent className="p-0">
              <div className="p-6 pb-4">
                <div className="flex items-center justify-between mb-6">
                  <div className={`${stat.bgColor} p-4 rounded-lg   shadow-sm transform group-hover:rotate-6 transition-transform duration-500`}>
