      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {loadingMargins ? (
          ...
          margins?.map((margin: any) => (
            <Card key={margin.id} className="border-none shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)] bg-white rounded-lg  overflow-hidden border border-slate-50 hover:shadow-xl transition-all duration-300 group ring-1 ring-slate-100/50">
