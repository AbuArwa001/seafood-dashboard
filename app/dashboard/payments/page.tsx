                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center text-slate-500 font-bold text-sm">
                            ...
                            {formatDate(payment.expected_payment_date, "PPP")}
                          </div>
                        </TableCell>
                        <TableCell>
                          {payment.actual_payment_date ? (
                            <div className="flex items-center bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider">
                              <CheckCircle2 className="h-3 w-3 mr-1" />
                              Paid{" "}
                              {formatDate(payment.actual_payment_date, "MMM d")}
                            </div>
                          ) : (
                            <div className="flex items-center bg-amber-50 text-amber-600 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider">
