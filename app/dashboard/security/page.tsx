...
function parseCodename(codename: string) {
  ...
  return {
    ...
    colorClass:
      ACTION_COLOR[action] ?? "bg-slate-50 text-slate-600 border-slate-100",
  };
}
              ...
              <CardContent className="px-7 pb-7 -mt-8 relative">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm text-slate-600">
                    <div className="bg-slate-50 h-8 w-8 rounded-lg flex items-center justify-center flex-none">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-0.5">
                      ...
                      {permissions.length !== 1 ? "s" : ""} granted to your role
                    </p>
                  </div>
                </div>
              </CardHeader>
                    ...
                    {Object.entries(grouped).map(([module, perms]) => (
                      <div key={module}>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {perms.map((perm) => {
                            const { actionLabel, colorClass } = parseCodename(
                              perm.codename,
                            );
                            return (
                              <span
                                key={perm.codename}
                                className={`inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider px-3 py-1.5 rounded-lg border ${colorClass}`}
                              >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-11 pr-11 h-14 rounded-2xl border-slate-100 bg-slate-50/70 focus:ring-2 font-semibold transition-all ${
